...
public class HotSpringSteamFactory implements IParticleFactory<HotSpringSteamData> {
    ...
    @Nullable
    @Override
    public Particle makeParticle(@Nonnull HotSpringSteamData typeIn, @Nonnull ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
