...
public class SimpleNoise {
    ...
    public static int getNoiseHeight(long seed, BlockPos blockPos, int diff, int loud) {
        ...
        if (blockPos.getX() % 16 == 0 && blockPos.getZ() % 16 == 0) {
            pos00 = new Vec2(blockPos.getX(), blockPos.getZ());
            pos01 = new Vec2(blockPos.getX(), blockPos.getZ() + 16);
            pos10 = new Vec2(blockPos.getX() + 16, blockPos.getZ());
        } else if (blockPos.getX() % 16 == 0) {
            int z = blockPos.getZ() % 16;
            pos00 = new Vec2(blockPos.getX(), blockPos.getZ() - z);
            pos01 = new Vec2(blockPos.getX(), blockPos.getZ() + 16 - z);
            pos10 = new Vec2(blockPos.getX() + 16, blockPos.getZ() - z);
        } else if (blockPos.getZ() % 16 == 0) {
            int x = blockPos.getX() % 16;
            pos00 = new Vec2(blockPos.getX() - x, blockPos.getZ());
            pos01 = new Vec2(blockPos.getX() - x, blockPos.getZ() + 16);
            pos10 = new Vec2(blockPos.getX() + 16 - x, blockPos.getZ());
        } else {
            int x = blockPos.getX() % 16;
            int z = blockPos.getZ() % 16;
            pos00 = new Vec2(blockPos.getX() - x, blockPos.getZ() - z);
            pos01 = new Vec2(blockPos.getX() - x, blockPos.getZ() + 16 - z);
            pos10 = new Vec2(blockPos.getX() + 16 - x, blockPos.getZ() - z);
        }
        ...
        return getSmoothY(new Vec3(pos00.x, random.nextInt(loud), pos00.y),
                new Vec3(pos01.x, random.nextInt(loud), pos01.y),
                new Vec3(pos10.x, random.nextInt(loud), pos10.y),
                blockPos, diff);
    }
     ...
     */
    public static int getSmoothY(Vec3 pos00, Vec3 pos01, Vec3 pos10,
