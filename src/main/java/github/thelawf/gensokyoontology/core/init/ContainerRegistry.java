...
public final class ContainerRegistry {
    ...
    public static final DeferredRegister<ContainerType<DanmakuCraftingContainer>> DANMAKU_CRAFTING_CONTAINER =
    ...
    public static final DeferredRegister<ContainerType<SorceryExtractorContainer>> SORCERY_EXTRACTOR_CONTAINER =
            CONTAINERS.register("sorcery_extractor_container", () -> IForgeContainerType.create(
                    ((windowId, inv, data) -> {
                        BlockPos pos = data.readBlockPos();
                        Level world = inv.player.world;
                        return new SorceryExtractorContainer(windowId, world, pos, inv);
                    })));
    public static final DeferredRegister<ContainerType<BinaryOperationContainer>> BINARY_OPERATION_CONTAINER =
    ...
    public static final DeferredRegister<ContainerType<V3dInvokerContainer>> V3D_INVOKER_CONTAINER =
    ...
    public static final DeferredRegister<ContainerType<SpellCardConsoleContainer>> SPELL_CONSOLE_CONTAINER =
    ...
    public static final DeferredRegister<ContainerType<StaticInvokerContainer>> STATIC_INVOKER_CONTAINER =
    ...
    public static final DeferredRegister<ContainerType<CBContainer>> CB_CONTAINER =
            CONTAINERS.register("cb_container", () -> IForgeContainerType.create(
                    ((windowId, inv, data) -> new CBContainer(windowId, inv))));
    public static final DeferredRegister<ContainerType<V3DBContainer>> V3DB_CONTAINER =
            CONTAINERS.register("v3db_container", () -> IForgeContainerType.create(
                    ((windowId, inv, data) -> new V3DBContainer(windowId, inv))));
    public static final DeferredRegister<ContainerType<DanmakuBuilderContainer>> DB_CONTAINER =
