...
public final class FeatureRegistry {
    ...
    public static final DeferredRegister<Feature<BaseTreeFeatureConfig>> CANOPY_FEATURE = FEATURES.register(
            "canopy_feature", () -> new CanopyFeature(BaseTreeFeatureConfig.CODEC.stable()));
    public static final DeferredRegister<WaterfallFeature> WATERFALL = FEATURES.register(
            "waterfall", () -> new WaterfallFeature(LiquidsConfig.CODEC.stable()));
    public static final DeferredRegister<Feature<MagicForestConfig>> MAGIC_FOREST_FEATURE = FEATURES.register(
