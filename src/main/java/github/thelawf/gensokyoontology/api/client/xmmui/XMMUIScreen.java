...
public abstract class XMMUIScreen extends Screen implements IXMLValueParser {
     ...
     */
    protected XMMUIScreen(Component titleIn, String xmlText) throws DocumentException {
        super(titleIn);
    ...
    protected void init() {
        super.init();
        // 获取所有表单元素及其下方的组件元素，根据组件元素的标签将其内部的属性值赋给EditBox或者Button
    }
    ...
    public void render(@NotNull MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.textData.forEach(data -> drawString(matrixStack, this.font, Component.translatable(data.text),
    ...
    public void drawTranslatedString(MatrixStack matrixStack, FontRenderer font, Component text, int x, int y, int hexColor) {
