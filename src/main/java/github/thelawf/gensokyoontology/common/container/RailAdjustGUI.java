...
public class RailAdjustGUI extends Screen {
    ...
    // private static final ResourceLocation ROTATE_ROLL = ResourceLocation.parse(GensokyoOntology.MODID +
    ...
    EditBox rotationRoll;
    EditBox rotationYaw;
    EditBox rotationPitch;
    ...
    public void addAdjustButtons(int x, int y) {
        ...
        increaseRoll = new Button(x + 120, y, 20, 20,
                Component.translatable("client." + GensokyoOntology.MODID +
        ...
        increaseRoll.setMessage(Component.translatable("client." + GensokyoOntology.MODID +
                ".button.increase_roll.msg"));
        decreaseRoll.setMessage(Component.translatable("client." + GensokyoOntology.MODID +
                ".button.decrease_roll.msg"));

        increaseYaw.setMessage(Component.translatable("client." + GensokyoOntology.MODID +
                ".button.increase_yaw.msg"));
        decreaseYaw.setMessage(Component.translatable("client." + GensokyoOntology.MODID +
                ".button.decrease_yaw.msg"));

        increasePitch.setMessage(Component.translatable("client." + GensokyoOntology.MODID +
                ".button.increase_pitch.msg"));
        decreasePicth.setMessage(Component.translatable("client." + GensokyoOntology.MODID +
    ...
    public void addOperationalButtons(int x, int y) {
        ...
        confirm = new Button(x + 140, y + 150, 60, 20,
            ...
            Vec3 rotation = new Vec3(roll, yaw, pitch);
    ...
    public void addTextFields() {
        rotationRoll = new EditBox(this.font, this.width / 2 - 20, 46, 100, 20,
                Component.translatable("client." + GensokyoOntology.MODID +
                        "text_field.rotation_roll"));
        rotationYaw = new EditBox(this.font, this.width / 2 - 20, 76, 100, 20,
                Component.translatable("client." + GensokyoOntology.MODID +
                        "text_field.rotation_yaw"));
        rotationPitch = new EditBox(this.font, this.width / 2 - 20, 106, 100, 20,
                Component.translatable("client." + GensokyoOntology.MODID +
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        // this.drawString(matrixStack, this.font, Component.translatable("client." + GensokyoOntology.MODID + "main.test"),this.width / 2 - 10, 30, 0xeb0505);
